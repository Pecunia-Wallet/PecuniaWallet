...
@Slf4j
@Component
public class AppStorageCleanupScheduler {

    @Value("${app.dir}") File appDir;

    public AppStorageCleanupScheduler(@Value("${app.dir}") String appDir) {
