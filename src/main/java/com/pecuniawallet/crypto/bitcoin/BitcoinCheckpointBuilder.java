...
public class BitcoinCheckpointBuilder {
    ...
    public void buildCheckpoints() throws Exception {
        ...
        writeBinaryCheckpoints(checkpoints, checkpointsFile);
    ...
    private static void writeBinaryCheckpoints(TreeMap<Integer, StoredBlock> checkpoints, File file) throws Exception {
        ...
        try (FileOutputStream fileOutputStream = new FileOutputStream(file, false);
            ...
            log.info(STR."Hash of checkpoints data is \{checkpointsHash}");
            log.info(STR."Checkpoints written to '\{file.getCanonicalPath()}'.");
        }
    }
