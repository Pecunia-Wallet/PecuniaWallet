...
public class BitcoinJsonRpcClient extends BitcoinJSONRPCClient {
    ...
    protected File MAIN_WORKING_DIR = new File(System.getProperty("user.home"), ".bitcoin");
    protected File TEST_WORKING_DIR = new File(System.getProperty("user.home"), ".bitcoin/testnet3/wallets");
    ...
    protected @Async void init() {
        try {
            ...
            log.error("Failed to ping Bitcoin RPC", e);
        }
    }
